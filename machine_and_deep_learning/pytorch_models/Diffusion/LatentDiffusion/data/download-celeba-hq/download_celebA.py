...
"Source: https://drive.google.com/drive/folders/0B7EVK8r0v71pWEZsZE9oNnFzTm8?resourcekey=0-5BR16BdXnb8hVj6CNHKzLg"
def download_celabA(dataset_dir):
    ...
    print("\n>>>>>>>>>>>>>>>>>>>>>>>>>> Downloading all _ATTRIBUTES_DRIVE info")
    download_and_check(_ATTRIBUTES_DRIVE, dataset_dir)
    print("\n>>>>>>>>>>>>>>>>>>>>>>>>>> Downloading all _IMGS_DRIVE info")
