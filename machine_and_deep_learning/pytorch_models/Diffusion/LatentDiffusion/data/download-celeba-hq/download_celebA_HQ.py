...
if __name__ == '__main__':
    ...
    "source: https://drive.google.com/drive/folders/0B4qLcYyJmiz0TXY1NG02bzZVRGs?resourcekey=0-arAVTUfW9KRhN-irJchVKQ&usp=drive_link"
    filenames = [
    ...
    print("\n>>>>>>>>>>>>>>>>>>>>>>>>>> Downloading all CELEBA-HQ info")
    for filename, drive_id, sha1_hex in zip(filenames, drive_ids, sha):
        ...
        if os.path.exists(save_path) and sha1_hex == checksum(save_path, 'sha1'):
