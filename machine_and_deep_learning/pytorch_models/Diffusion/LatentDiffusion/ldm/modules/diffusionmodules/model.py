...
def make_attn(in_channels, attn_type="vanilla"):
    ...
    LOGI(f"making attention of type '{attn_type}' with {in_channels} in_channels")
...
class Upsampler(nn.Module):
    def __init__(self, in_size, out_size, in_channels, out_channels, ch_mult=2):
        ...
        LOGI(f"Building {self.__class__.__name__} with in_size: {in_size} --> out_size {out_size} and factor {factor_up}")
