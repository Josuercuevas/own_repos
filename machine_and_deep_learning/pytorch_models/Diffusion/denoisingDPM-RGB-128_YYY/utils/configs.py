...
PARAM_SETTING = {
    ...
    "iterations": 2000000, # in the paper they trained for 800k iterations, for 1000 steps #vanny change it to 2mill bc the results are still blurry after trained in 800k iteration
    ...
    "num_groups": 32, # appendix B in paper https://arxiv.org/pdf/2006.11239.pdf
    "num_classes": 10, # for label conditioning
    "img_channels": 3,
    "img_size": (128, 128), # H and W of the image to be processed
    "image_pad": 0,
