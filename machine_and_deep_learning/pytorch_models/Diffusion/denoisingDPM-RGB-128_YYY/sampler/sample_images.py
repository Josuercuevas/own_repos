...
class DiffusionModelSampler:
    ...
    def get_samples(self, smp_per_class=100):
        ...
        with torch.no_grad():
            ...
            while end_smp <= total_images:
                ...
                for idx in range(samples.shape[0]):
                    ...
                    output_path = "D://Images for paper//Cifar 128x128//generated images from RGB128"
                    im.save(os.path.join(output_path, f"iimg_{img_idx}.png"))
