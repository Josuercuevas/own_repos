/*
  Testing unit for the permute layer to be used in caffe during the
  interpretation of the ConvDet results.

  The results coming from here are for consistency of the results, they should
  provide correct backward and forward passes through the network
...
namespace caffe {
  ...
  static const float eps = 1e-6; //minimum value to be used in the weights
